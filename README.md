...
## Overview
A lightweight, offline-first financial dashboard built entirely with vanilla JavaScript. It processes and visualises user metrics without requiring backend computation, ensuring zero-latency data persistence and absolute data privacy.
